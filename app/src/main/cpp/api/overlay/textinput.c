...
int NewTextInput(lua_State *L) {
	...
	GET_ENV(); GET_CLS();
	jmethodID m = VOID_METHOD("addTextInput", "(Ljava/lang/String;FFFFLjava/lang/String;)V");
...
static int ti_setText(lua_State *L) {
	...
	GET_ENV(); GET_CLS();
	jmethodID m = VOID_METHOD("setTextInputText", "(Ljava/lang/String;Ljava/lang/String;)V");
	jstring jid = JID(env, ti);
...
static int ti_getText(lua_State *L) {
	MiniTextInput *ti = CHECK_TEXTINPUT(L);
	GET_ENV(); GET_CLS();
	jmethodID m = (*env)->GetStaticMethodID(env, cls, "getTextInputText", "(Ljava/lang/String;)Ljava/lang/String;");
	jstring jid = JID(env, ti);
...
static int ti_setHint(lua_State *L) {
	...
	GET_ENV(); GET_CLS();
	jmethodID m = VOID_METHOD("setTextInputHint", "(Ljava/lang/String;Ljava/lang/String;)V");
	jstring jid = JID(env, ti);
	jstring jhint = (*env)->NewStringUTF(env, hint);
...
static int ti_setBackgroundResource(lua_State *L) {
	...
	GET_ENV(); GET_CLS();
	jmethodID m = VOID_METHOD("setTextInputBackgroundResource", "(Ljava/lang/String;Ljava/lang/String;)V");
	jstring jid = JID(env, ti);
...
static int ti_setFont(lua_State *L) {
	...
	GET_ENV(); GET_CLS();
	jmethodID m = VOID_METHOD("setTextInputFont", "(Ljava/lang/String;Ljava/lang/String;)V");
	jstring jid = JID(env, ti);
...
static int ti_isFocused(lua_State *L) {
	MiniTextInput *ti = CHECK_TEXTINPUT(L);
	GET_ENV(); GET_CLS();
	jmethodID m = (*env)->GetStaticMethodID(env, cls, "isTextInputFocused", "(Ljava/lang/String;)Z");
	jstring jid = JID(env, ti);
...
static int ti_setSelection(lua_State *L) {
	...
	if (argc == 2) {
		...
		(*env)->CallStaticVoidMethod(env, cls, m, jid, (int)luaL_checkinteger(L, 2), (int)luaL_checkinteger(L, 3));
	}
	(*env)->DeleteLocalRef(env, jid);
	lua_settop(L, 1);
	return 1;
...
static int ti_getSelection(lua_State *L) {
	MiniTextInput *ti = CHECK_TEXTINPUT(L);
	GET_ENV(); GET_CLS();
	jmethodID m = (*env)->GetStaticMethodID(env, cls, "getTextInputSelection", "(Ljava/lang/String;)[I");
	jstring jid = JID(env, ti);
